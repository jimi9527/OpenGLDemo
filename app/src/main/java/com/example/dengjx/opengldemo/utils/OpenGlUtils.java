...
import com.example.dengjx.opengldemo.filter.FilterConstants;
...
public class OpenGlUtils {
    ...
    public static int loadTexture(final Buffer data, final Point size, final int usedTexId) {
        return loadTexture(data, size.x, size.y, usedTexId);
    }
    ...
    public static void deleteTexture(int textureId) {
        ...
        arrayOfInt[0] = textureId;
        GLES20.glDeleteTextures(1, arrayOfInt, 0);
        Log.d(TAG, "delete textureId " + textureId);
    }

    public static void bindTextureToFrameBuffer(int fbBufferId, int fbTextureId, int width, int height) {
        OpenGlUtils.bindTexture(GLES20.GL_TEXTURE_2D, fbTextureId);
        ...
        OpenGlUtils.bindTexture(GLES20.GL_TEXTURE_2D, 0);
    ...
    public static void bindTexture(int target, int texture) {
        ...
        if (FilterConstants.DEBUG_GL_ERROR) {
            checkGlError("bindTexture id " + texture + " ");
        }
    }
